...
wordCounts = wordPairs.reduceByKey(lambda a,b: b+1)
...
# TODO: Replace <FILL IN> with appropriate code
uniqueWords = wordCountsGrouped.count()
print uniqueWords
...
# TODO: Replace <FILL IN> with appropriate code
shakeWordsRDD = shakespeareWordsRDD.filter(lambda x: len(x.strip()) != 0)
